...
public class DronesController {
	...
	List<MedicationDto> getDroneMedications(
			@PathVariable(name = UrlConstants.DRONE_NUMBER_IN_PATH) String droneNumber) {
	...
	int getDroneBatteryCapacity(@PathVariable(name = UrlConstants.DRONE_NUMBER_IN_PATH) String droneNumber) {
		log.debug("received: drone number {}", droneNumber);
